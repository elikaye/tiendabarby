  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-black/70 backdrop-blur-md shadow-md">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-2">
       ...
       <div className="absolute top-full left-0 pt-2 bg-white shadow-lg rounded-md py-2 px-4 z-50 min-w-[220px]">
                  ...
                  {subcategorias[to].map((sub) => (
                    ...
                    <Link
                      ...
                      className="block px-2 py-1 text-sm text-gray-800 hover:bg-pink-100 rounded"
                    >
                      {sub}
                    </Link>
      ...
      {menuOpen && (
        <nav className="md:hidden bg-black/10 backdrop-blur-md px-6 py-4 flex flex-col gap-3 font-bold">
            ...
            <div key={to} className="flex flex-col">
              ...
              <div
                className={`flex items-center justify-between cursor-pointer ${
                  activeSection === to ? "text-pink-500" : "text-white"
                }`}
                onClick={() => {
